    ...
    <View className='bg-primary flex-1'>
      <ScrollView contentContainerStyle={{paddingBottom: 80}}>
        ...
        <View className='flex-col items-start justify-center mt-5 px-5'>
          ...
          <TouchableOpacity className='absolute top-3 right-5 rounded-full size-10 bg-transparent flex items-center justify-center'>
            <Image 
              source={icons.save}
              className='w-6 h-7'
              resizeMode='stretch'
      ...
      <TouchableOpacity className='absolute bottom-10 left-0 right-0 mx-5 bg-accent rounded-full py-3.5 flex flex-row items-center justify-center z-50' onPress={router.back}>
